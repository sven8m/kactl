 ...
 * License: CC0
 * Source: folklore
 * Description: Suffix automaton, automaton which accepts all suffixes
 * of a given string. aut[state][char] gives transition
 * and isFinal[state] says if state is final. len[state] is the length
 * of string corresponding to that state.
 * Time: Linear
 * Status: Unknown
 */
